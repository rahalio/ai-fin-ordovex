 ...
 *
 * Barrel export for concentration service, types, hooks, and view models.
 *
 * Architecture Rules:
 * - API types: re-exports from @ordovex/core only
...
// ============================================================================
export { concentrationService } from './concentration.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { concentrationFacade } from './facade';
