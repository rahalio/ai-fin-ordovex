 ...
 *
 * @returns The core table name (e.g., "ordovex-core-dev")
 ...
 *
 * @returns The base table name (e.g., "ordovex-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "ordovex-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "ordovex-app-realtime-dev")
