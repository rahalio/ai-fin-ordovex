/**
 * Incidents Services - Application Layer Export
 *
...
/**
 * Incidents Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for incidents domain.
 */
