/**
 * Pretrade Services - Application Layer Export
 *
...
/**
 * Pretrade Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for pretrade domain.
 */
